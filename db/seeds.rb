...
event1 = Event.create(postcode: 'EC1M 4AN', restaurant_name: 'Dans Le Noir', start_time: '2021-09-01 18:30:00 -0700', end_time: '2021-09-01 21:30:00 -0700', category: 7, event_name: 'Delight Moment', event_descritpion: 'It is designed to heighten the senses and change perceptions.', price: 60, image_url: 'event-image1.png', user_id: user3.id)
...
event11 = Event.create(postcode: 'EC4V 5BY', restaurant_name: 'Tapas Tuesday', start_time: '2021-09-19 16:00:00 -0700', end_time: '2022-09-30 12:30:00 -0700', category: 20, event_name:'Spanish Night 💃🏽', event_descritpion: "Eat, drink, dance, repeat", price: 35, image_url: 'event-image9.jpg', user_id: user1.id)
event12 = Event.create(postcode: 'EC2A 3AT', restaurant_name: 'Cocorico', start_time: '2021-09-10 13:30:00 -0700', end_time: '2022-09-30 12:30:00 -0700', category: 24, event_name:'Start the weekend off Veggie', event_descritpion: "The focus of this event is on sustainable vegetarian ingredients — from locally foraged herbs to 'ugly' produce that would normally be discarded.", price: 25, image_url: 'event-image3.png', user_id: user3.id)
event13 = Event.create(postcode: 'EC3R 7AF', restaurant_name: 'Naifs', start_time: '2021-10-02 16:30:00 -0700', end_time: '2022-09-30 12:30:00 -0700', category: 24, event_name:'South London goes Vegan', event_descritpion: "The food offering at this event consists largely of moreish sharing plates, including plenty of vegan options. Think a mustard leaf and pear Caesar salad, aubergine fritters with Spenwood custard, and Crown Prince squash topped with labneh and spiced butter.", price: 40, image_url: 'event-image2.jpg', user_id: user2.id)
...
event15 = Event.create(postcode: 'E1 6ST', restaurant_name: 'Kin', start_time: '2021-09-30 07:00:00 -0700', end_time: '2022-09-30 12:30:00 -0700', category: 24, event_name:'Brunch. Drink. Vegetarian.', event_descritpion: "Quaint eatery specialising in vegan breakfast staples, sandwiches & sweets, plus coffee & smoothies.", price: 40, image_url: 'sweetfood.jpg', user_id: user1.id)
event16 = Event.create(postcode: 'EC1V 4NN', restaurant_name: 'The Gate', start_time: '2021-11-12 13:15:00 -0700', end_time: '2022-09-30 12:30:00 -0700', category: 24, event_name:'California Vegetarian Food Festival', event_descritpion: "The best food festival ever. Drinks, food and good vibes only.", price: 27, image_url: 'event-image7.jpg', user_id: user3.id)
...
booking1 = Booking.create(user_id: user5.id, event_id: event3.id, ticket_amount: 3)
...
booking4 = Booking.create(user_id: user6.id, event_id: event4.id, ticket_amount: 1)
booking5 = Booking.create(user_id: user5.id, event_id: event12.id, ticket_amount: 5)

puts 'Adding several reviews for organizers'

Review.create(user_id: user2.id, booking_id: booking1.id, content: 'Amazing food!!! It was full of surprises!! Thanks Enigma and your great organizer team!!')
...
Review.create(user_id: user2.id, booking_id: booking4.id, content: 'Probably the best dinner experience in London!')
Review.create(user_id: user3.id, booking_id: booking5.id, content: 'I honestly loved every single second of this experience. 10/10 would recommend!!')
...
Favourite.create(user_id: user2.id, event_id: event1.id)
