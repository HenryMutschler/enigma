...
event2 = Event.create(postcode: 'E1 6QR', restaurant_name: 'Caboose', start_time: '2021-09-16 11:30:00 -0700', end_time: '2021-09-16 14:30:00 -0700', category: 0, event_name: 'BYOB (oooo yea!)', event_descritpion: 'Hailed as the most unique group dining experience in London.', price: 35, image_url: 'event-image8.jpg', user_id: user2.id)
...
event15 = Event.create(postcode: 'W1W 6DT', restaurant_name: 'Kin', start_time: '2021-12-01 07:00:00 -0700', end_time: '2022-09-30 12:30:00 -0700', category: 24, event_name:'Brunch. Drink. Vegetarian.', event_descritpion: "Quaint eatery specialising in vegan breakfast staples, sandwiches & sweets, plus coffee & smoothies.", price: 40, image_url: 'sweetfood.jpg', user_id: user1.id)
