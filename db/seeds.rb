...
event1 = Event.create(postcode: 'EC1M 4AN', restaurant_name: 'Dans Le Noir', start_time: '2021-09-01 18:30:00 -0700', end_time: '2021-09-01 21:30:00 -0700', category: 'French', event_name: 'Delight Moment', event_descritpion: 'It is designed to heighten the senses and change perceptions.', price: 60)
event2 = Event.create(postcode: 'E1 6QR', restaurant_name: 'Caboose', start_time: '2021-09-16 11:30:00 -0700', end_time: '2021-09-16 14:30:00 -0700', category: 'American', event_name: 'BYOB (oooo yea!)', event_descritpion: 'Hailed as the most unique group dining experience in London.', price: 35)
event3 = Event.create(postcode: 'W1U 3JR', restaurant_name: 'Xier', start_time: '2021-09-19 11:30:00 -0700', end_time: '2021-09-19 14:30:00 -0700', category: 'Modern European', event_name: 'Scandinavia & further afield in Japan', event_descritpion: 'The menu comprises of the finest season ingredients, all of which are combined to create a divine ten-course tasting menu.', price: 120)
event4 = Event.create(postcode: 'W1T 3NB', restaurant_name: 'Greyhoun Cafe', start_time: '2021-09-26 11:00:00 -0700', end_time: '2021-09-26 14:30:00 -0700', category: 'Thai', event_name: 'Bringing a taste of Bangkok to central London', event_descritpion: "When it comes to restaurants in London, sometimes it feels like we've seen it all before, but that's certainly not the case", price: 70)
event5 = Event.create(postcode: 'SW1W 0PS', restaurant_name: 'The English Grill', start_time: '2021-09-30 11:00:00 -0700', end_time: '2021-09-30 14:30:00 -0700', category: 'British', event_name: 'Plush, decadent and bursting with old-school British charm', event_descritpion: "Dishes offer the finest British and seasonal produce, including top-quality cuts of meat, handled to perfection in the kitchen's charcoal-fired Josper grill.", price: 180)
